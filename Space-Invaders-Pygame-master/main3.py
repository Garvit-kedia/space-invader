...
restart_rect = restart_text.get_rect(bottomright=(800, 600))

# Quit Button
quit_font = pygame.font.Font('freesansbold.ttf', 24)
quit_text = quit_font.render("Quit", True, (255, 255, 255))
quit_rect = quit_text.get_rect(bottomleft=(10, 590))
...
while running:
    ...
    if not game_started:
        pygame.draw.rect(screen, (0, 0, 0), (0, 0, 800, 50))  # Black box at the top
        pygame.draw.rect(screen, (255, 255, 255), (10, 10, 780, 30))  # White box for text
        start_text = font.render("Press Space to start    if  score greater than 10 you move to level 2", True, (0, 0, 0))
        ...
        show_level(650, 10)  # Moved level option slightly to the left
